...
ACLOCAL = ${SHELL} /usr/src/jpeg/opencl-jpeg/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /usr/src/jpeg/opencl-jpeg/missing autoconf
AUTOHEADER = echo autoheader ignored
AUTOMAKE = ${SHELL} /usr/src/jpeg/opencl-jpeg/missing automake-1.15
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /usr/src/jpeg/opencl-jpeg/missing makeinfo
MANIFEST_TOOL = :
MEMORYMGR = jmemnobs
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
STRIP = strip
VERSION = 8.0
abs_builddir = /usr/src/jpeg/opencl-jpeg
abs_srcdir = /usr/src/jpeg/opencl-jpeg
abs_top_builddir = /usr/src/jpeg/opencl-jpeg
abs_top_srcdir = /usr/src/jpeg/opencl-jpeg
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/jpeg/opencl-jpeg/install-sh
